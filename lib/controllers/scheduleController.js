...
exports.create = function(req, res, container) {
    ...
    container.getService('MONGODB').then(function(service) {
        ...
        // check the PK
        service.send('findOne', {collectionName : 'schedule', query : {where : {_appid : req.session.appid, name : data.name}}}, function(err, doc) {
...
exports.read = function(req, res, container) {
    ...
    container.getService('MONGODB').then(function(service) {
        ...
        service.send('findOne', {collectionName : 'schedule', query : {where : {_appid : req.session.appid, objectId : req.params._objectId}}}, function(err, doc) {
...
exports.update = function(req, res, container) {
    ...
    container.getService('MONGODB').then(function(service) {
        ...
        service.send('update', {collectionName : 'schedule', query : {where : {_appid : req.session.appid, objectId : req.params._objectId}}, data : data}, function(err, doc) {
...
exports.find = function(req, res, container) {
    ...
    container.getService('MONGODB').then(function (service) {
        ...
        req.query.where._appid = req.session.appid;
...
exports.destroy = function(req, res, container) {
    ...
    container.getService('MONGODB').then(function(service) {
        ...
        service.send('remove', {collectionName : 'schedule', query : {where : {_appid : req.session.appid, objectId : req.params._objectId}}}, function(err, doc) {
...
exports.destroyAll = function(req, res, container) {
    ...
    container.getService('MONGODB').then(function(service) {
        ...
        service.send('remove', {collectionName : 'schedule', query : {where : {_appid : req.session.appid}}} , function(err, doc) {
